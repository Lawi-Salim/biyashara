...
const VendeurNotifications = ({ selectedType }) => {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        ...
        const { data } = await apiService.get('/notifications/vendeur', {
          params,
        });
        setNotifications(data);
      } catch (err) {
        const errorMessage = 'Impossible de charger les notifications vendeur.';
